    ...
    <div class="col-md-4">
        <div class="card shadow bg-white">
            ...
            <div class="card-body row">
                ...
                <label class="col-md-8 col-form-label"><?php echo $detail['nama-lengkap_pelanggan']; ?></label>
                <!-- -->
                ...
                <label class="col-md-8 col-form-label"><?php echo $detail['no-telepon_pelanggan']; ?></label>
                <!-- -->
            </div>
        </div>
    </div>
