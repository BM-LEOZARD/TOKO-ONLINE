    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">BM STORE</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?halaman=kelola-pelanggan">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if(isset($_GET['halaman']))
                    {
                        ...
                        {
                            include 'edit/edit-kategori.php';
                        }
                        ...
                        {
                            include 'detail/detail-produk.php';
                        }
                        elseif($_GET['halaman']=="hapus_foto")
                        {
                            include 'hapus/hapus-foto.php';
                        }
                        elseif($_GET['halaman']=="edit_produk")
                        {
                            include 'edit/edit-produk.php';
                        }
                        ...
                        {
                            include 'detail/detail-pembelian.php';
                        }
                        ...
                        //Halaman Pelanggan
                        elseif($_GET['halaman']=="kelola-pelanggan")
                        {
                            include 'kelola-pelanggan.php';
                        }
                    }
                    else
                    {
